...
describe('Some Acceptance test', () => {
    ...
    it('should load with entries from the backend', function () {
        ...
        cy.route("GET", "http://backend.de/api/v1/days/2002-02-01/bookings", "fixture:day_2002-02-01_entries.json")
            .as("entriesLoad");
    ...
    it('it should be possible to delete specific entries', function () {
        ...
        cy.route({
            ...
            response: "",
            method: "DELETE",
            url: "http://backend.de/api/v1/days/2002-02-01/bookings/*"
        }).as("entryDelete");
    ...
    it('element should be saved if clicked on save and reloaded the day after', () => {
        ...
        cy.route({
            method: "PUT",
            url: "http://backend.de/api/v1/days/2002-02-01/bookings/65b8818f-0320-450b-9da0-49f3269bafd7",
            status: 200
        }).as("entryUpdate");
